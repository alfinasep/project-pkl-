      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="admin/dist/img/images.jpeg" class="user-image" alt="User Image">
              <span class="hidden-xs">Alfina septrianti</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="admin/dist/img/images.jpeg" class="img-circle" alt="User Image">

                <p>
                  Alfina Septrianti - Pelajar
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="admin/dist/img/images (2).jpg" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/pendaftaran"><i class="fa fa-circle-o"></i> Crud Pendaftaran</a></li>
            <li><a href="/perpustakaan"><i class="fa fa-circle-o"></i> Crud Perpustakaan</a></li>
            <li><a href="/riwayat"><i class="fa faa-circle-o"></i> Crud Biodata </a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>JQuery</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/nah"><i class="fa fa-circle-o"></i>JQuery Perhitungan </a></li>
            <li><a href="/contoh"><i class="fa fa-circle-o"></i>JQuery Latihan </a></li>
          </ul>
        </li>
        <li>
          <a href="pages/calendar.html">
            ...
            <span class="pull-right-container">
              ...
              <small class="label pull-right bg-blue">13</small>
            </span>
          </a>
        </li>
        <li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>Documentation</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li><a href="http://jquery.com/"><i class="fa fa-circle-o"></i>JQuery</a></li>
          </ul>
        </li>
      </ul>
    </section>
